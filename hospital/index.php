 ...
 * @Last Modified time: 2018-11-22 15:54:15
 */
?>
          ...
          <ul aria-labelledby="notifications" class="dropdown-menu">
           <li><a rel="nofollow" href="#" class="dropdown-item"> 
            ...
            <li ng-repeat="vala in notifications track by $index">
              <a rel="nofollow" href="hospital-notification/{{vala.key}}" class="dropdown-item border mb-1"> 
                <div class="notification d-block justify-content-between">
            ...
            <li><a rel="nofollow" href="hospital-notification" class="dropdown-item all-notifications text-center"> <strong> <i class="fa fa-bell"></i>view all notifications                                            </strong></a></li>
          </ul>
        </li>
        <?php if(false): ?>
          <!-- Messages dropdown-->
