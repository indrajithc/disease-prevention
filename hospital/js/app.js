...
* @Last Modified time: 2018-11-22 15:50:47
*/
...
hospital_app.config([ '$routeProvider', '$locationProvider', function( $routeProvider, $locationProvider ) {
	...
	.when('/hospital-notification', {
		templateUrl: 'hospital/pages/notification.html',
		controller: 'hospital_appControllerNotification'
	}) 


	.when('/hospital-notification/:param1', {
		templateUrl: 'hospital/pages/notification.html',
		controller: 'hospital_appControllerNotification'
	}) 
...
hospital_app.controller( 'hospital_appControllerNotification', function($timeout, $scope, $http, $location, $filter,$sce, myservice, toastr, cfpLoadingBar, serverService){
	doCheckUser($scope, $http);
