 ...
 * @Last Modified time: 2018-11-22 11:25:07
 */
?>
  ...
  <link rel="text/css" href="assets/css/custom.css">
    ...
    <div class="main-menu">
      ...
      <ul id="side-main-menu" class="side-menu list-unstyled">                  
        ...
        <li ng-class="{'active' : currentLin == 'admin-notification' }" ><a href="admin-notification"> <i class="icon-presentation"></i>Notification                             </a></li>
